...
namespace LizardsConsole
{
    class Program
    {
        ...
        private void _ShowLizData(int LizNum)
        {
            ...
            CurrentLizardMenu.AddItem('1', "Event 1", () => Liz.MainEvents[0] = new LizardData.Record(Liz, "Event 1"));
            CurrentLizardMenu.AddItem('2', "Event 2", () => Liz.MainEvents[1] = new LizardData.Record(Liz, "Event 2"));
            CurrentLizardMenu.AddItem('3', "Event 3 (stop)", () =>
            {
                Liz.MainEvents[2] = new LizardData.Record(Liz, "Event 3");
                Liz.Stop();
            });
